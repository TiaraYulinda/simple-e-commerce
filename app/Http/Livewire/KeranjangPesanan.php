...
class KeranjangPesanan extends Component
{
    ...
    public function destroy($id)
    {
        ...
        if (!empty($pesanan_detail)) {
            ...
            $this->emit('masukKeranjang'); //update keranjang
    ...
    {
        //validasi apakah user sudah login, jika user login
        if (Auth::user()) {
        ...
        return view('livewire.keranjang-pesanan', [
            //untuk mengeluarkan data di keranjang pesanan
